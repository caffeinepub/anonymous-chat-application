...
export function useCreateRoom() {
  ...
  return useMutation({
    mutationFn: async ({ joinCode, nickname }: { joinCode: string; nickname: string }) => {
      ...
      console.log('[useCreateRoom] Calling backend createRoom with code:', joinCode, 'nickname:', nickname);
      try {
...
export function useJoinRoom() {
  ...
  return useMutation({
    mutationFn: async ({ joinCode, nickname }: { joinCode: string; nickname: string }) => {
      ...
      console.log('[useJoinRoom] Calling backend joinRoom with code:', joinCode, 'nickname:', nickname);
...
export function useDeleteMessage(roomId: string) {
  ...
  return useMutation({
    mutationFn: async ({ messageId, userId }: { messageId: bigint; userId: string }) => {
      if (!actor) throw new Error('Actor not initialized');
