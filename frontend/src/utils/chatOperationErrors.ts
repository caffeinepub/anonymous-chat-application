...
export function logOperationError(operation: string, error: unknown): ChatOperationError {
  const { code: rejectCode, message: rejectMessage } = extractICRejectDetails(error);
