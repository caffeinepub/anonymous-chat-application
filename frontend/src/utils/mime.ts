...
export function isImageMimeType(mimeType: string): boolean {
  return IMAGE_MIME_TYPES.includes(mimeType as any) || mimeType.startsWith('image/');
}
 ...
 */
export function generateFallbackFilename(contentType: string, prefix: string = 'file'): string {
