...
export class Backend implements backendInterface {
    ...
    async addReaction(arg0: string, arg1: bigint, arg2: string, arg3: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async createRoom(arg0: string, arg1: string): Promise<{
        joinCode: string;
    }> {
        if (this.processError) {
            try {
    ...
    async editMessage(arg0: string, arg1: bigint, arg2: string, arg3: string, arg4: MediaFile | null, arg5: MediaFile | null, arg6: MediaFile | null): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async fetchMessagesAfterId(arg0: string, arg1: bigint): Promise<Array<MessageView>> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchMessagesAfterId(arg0, arg1);
    ...
    async getMessageTTL(): Promise<Time> {
        if (this.processError) {
            try {
                const result = await this.actor.getMessageTTL();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async sendMessage(arg0: string, arg1: string, arg2: string, arg3: bigint | null, arg4: MediaFile | null, arg5: MediaFile | null, arg6: MediaFile | null, arg7: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.sendMessage(arg0, arg1, arg2, to_candid_opt_n25(this._uploadFile, this._downloadFile, arg3), await to_candid_opt_n10(this._uploadFile, this._downloadFile, arg4), await to_candid_opt_n10(this._uploadFile, this._downloadFile, arg5), await to_candid_opt_n10(this._uploadFile, this._downloadFile, arg6), arg7);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_MediaFile_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MediaFile): Promise<MediaFile> {
    return await from_candid_record_n19(_uploadFile, _downloadFile, value);
}
async function from_candid_MessageView_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MessageView): Promise<MessageView> {
...
async function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_MediaFile]): Promise<MediaFile | null> {
    return value.length === 0 ? null : await from_candid_MediaFile_n18(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        audio: record_opt_to_undefined(await from_candid_opt_n17(_uploadFile, _downloadFile, value.audio)),
        video: record_opt_to_undefined(await from_candid_opt_n17(_uploadFile, _downloadFile, value.video)),
        isEdited: value.isEdited,
        nonce: record_opt_to_undefined(from_candid_opt_n21(_uploadFile, _downloadFile, value.nonce)),
...
async function from_candid_vec_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_MessageView>): Promise<Array<MessageView>> {
    return await Promise.all(value.map(async (x)=>await from_candid_MessageView_n15(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_opt_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MediaFile | null): Promise<[] | [_MediaFile]> {
    return value === null ? candid_none() : candid_some(await to_candid_MediaFile_n11(_uploadFile, _downloadFile, value));
}
...
async function to_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        originalName: value.originalName,
        contentType: value.contentType,
        file: await to_candid_ExternalBlob_n13(_uploadFile, _downloadFile, value.file)
    };
}
